...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "emcms_at_localhost";
		$data["connName"] = "emcms at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;hardrock;;emcms;;1"; //currently unused

		$this->_connectionsIdByName["emcms at localhost"] = "emcms_at_localhost";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "hardrock";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][2] = "hardrock";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "emcms";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=hardrock;Database=emcms;OPTION=3";
		// encription set
		...
		$connectionsData["emcms_at_localhost"] = $data;
