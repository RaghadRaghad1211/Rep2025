...
class tDAL
{
	var $tblemcms_at_localhost__committes_list;
	var $tblemcms_at_localhost__info_patinat;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "committes_list", "varname" => "emcms_at_localhost__committes_list", "altvarname" => "committes_list", "connId" => "emcms_at_localhost", "schema" => "", "connName" => "emcms at localhost");
		$this->lstTables[] = array("name" => "info_patinat", "varname" => "emcms_at_localhost__info_patinat", "altvarname" => "info_patinat", "connId" => "emcms_at_localhost", "schema" => "", "connName" => "emcms at localhost");
	}
