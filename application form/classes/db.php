...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "emcms_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "committes_list", "varname" => "emcms_at_localhost__committes_list", "altvarname" => "committes_list", "connId" => "emcms_at_localhost", "schema" => "", "connName" => "emcms at localhost");
			$dalTables[$conn->connId][] = array("name" => "info_patinat", "varname" => "emcms_at_localhost__info_patinat", "altvarname" => "info_patinat", "connId" => "emcms_at_localhost", "schema" => "", "connName" => "emcms at localhost");
		}
	}
